...
function App() {
	...
	const generateDesign = async () => {
		...
		try {
			...
			console.error(err);
			setMessage(
				err.message || "Something went wrong generating your design. Try again."
			);
		} finally {
			setLoading(false);
		}
			...
			<main>
				...
				{generated && designs.length > 0 && (
					<section className="design-section">
						...
						<p className="design-intro">
							Your idea is ready. Choose the version you want to put on
				...
				<section className="products-section" id="shop">
					<div className="section-heading">
						...
						<p>
							Choose your piece. Create your design. Make it yours.
						</p>
					</div>
						...
						{(Object.keys(products) as Product[]).map((item) => (
							...
							>
								...
								<div className="product-info">
									<h3>{item}</h3>
									<p>
										Your blank canvas for whatever you want to create.
									</p>
				...
				<section className="how-section" id="how">
					...
					<div className="steps">
						...
						<div className="step">
							...
							<h3>CREATE</h3>
							<p>
								Describe your idea and turn your imagination into artwork.
							</p>
						</div>
						<div className="step">
							<span>03</span>
							<h3>CUSTOMIZE</h3>
							<p>
								Choose your colors, size, placement, and favorite design.
							</p>
						</div>
						<div className="step">
							<span>04</span>
							<h3>WEAR IT</h3>
							<p>
								Add it to your cart and eventually have it printed and
