...
function App() {
	...
	const [designs, setDesigns] = useState<string[]>([]); // base64 or URLs
	...
	const generateDesign = async () => {
		...
		try {
			...
			// Expecting { designs: string[] } where each string is a data URL or image URL
	...
	return (
		<div className="site">
			...
			<main>
				...
				{/* Keep your existing products-section and how-section exactly as they are */}
				<section className="products-section" id="shop">
					{/* ... your existing shop code ... */}
				</section>

				<section className="how-section" id="how">
					{/* ... your existing how-it-works code ... */}
				</section>
			</main>
